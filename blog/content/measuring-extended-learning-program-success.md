---
title: "How to Measure Whether Your Extended Learning Program Is Actually Working"
description: "You are running an after-school or summer program. You think it is working. But how do you know? Here is a practical measurement framework for extended learning."
date: "2026-01-01"
...
- Attendance trend over time (is it stable, improving, or declining?)
- Dosage (total hours of programming each student receives)
- Enrollment vs. consistent attendance (how many enrolled students attend at least 75% of sessions?)
...
**What to measure:**
- Implementation fidelity (is the curriculum being followed? Are activities delivered as designed?)
- Staff quality (observation ratings, qualifications, retention)
- Student engagement (observed engagement during activities, not just physical presence)
- Student and family satisfaction (brief surveys, two to three questions)
...
**What to measure:**
- Academic growth (using assessments that students take regardless of program participation, like district benchmarks)
- School-day attendance (do program participants attend school more regularly?)
- Behavioral indicators (discipline referrals, suspensions)
- Social-emotional skills (survey-based measures)
- Grade promotion and graduation rates (for older students)
